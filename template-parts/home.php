...
<main class="main">
        ...
        <div class="container">
            <div class="row gy-4 justify-content-center justify-content-lg-between">
                <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <p data-aos="fade-up" data-aos-delay="100"><?php echo esc_html__(get_theme_mod('tagline')); ?></p>
    ...
    <section id="testimonials" class="testimonials section light-background">
        ...
        <!-- Section Title -->
        <div class="container section-title" data-aos="fade-up">
            <h2><?php echo esc_html__('TESTIMONIALS'); ?></h2>
            <p><?php echo esc_html__('What Are They'); ?> <span class="description-title"><?php echo esc_html__('Saying About Us'); ?></span></p>
        </div><!-- End Section Title -->
                        ...
                        <div class="testimonial-item">
                            <div class="row gy-4 justify-content-center">
                                ...
                                <div class="col-lg-2 text-center">
                                    <img src="<?php echo get_theme_file_uri() . "/assets/img/testimonials/testimonials-1.jpg" ?>" class="img-fluid testimonial-img" alt="">
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="row gy-4 justify-content-center">
                                ...
                                <div class="col-lg-2 text-center">
                                    <img src="<?php echo get_theme_file_uri() . "/assets/img/testimonials/testimonials-2.jpg" ?>" class="img-fluid testimonial-img" alt="">
                                </div>
                            </div>
                        </div>
                    </div><!-- End testimonial item -->
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="row gy-4 justify-content-center">
                                ...
                                <div class="col-lg-2 text-center">
                                    <img src="<?php echo get_theme_file_uri() . "/assets/img/testimonials/testimonials-3.jpg" ?>" class="img-fluid testimonial-img" alt="">
                                </div>
                            </div>
                        </div>
                    </div><!-- End testimonial item -->
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-item">
                            <div class="row gy-4 justify-content-center">
                                ...
                                <div class="col-lg-2 text-center">
                                    <img src="<?php echo get_theme_file_uri() . "/assets/img/testimonials/testimonials-4.jpg" ?>" class="img-fluid testimonial-img" alt="">
                                </div>
                            </div>
                        </div>
                    </div><!-- End testimonial item -->
